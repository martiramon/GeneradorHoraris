...
class DriverRestriccioMatiTarda {
	private static inout io;
	private static RestriccioMatiTarda r;
	...
	public static void testConstructor() throws Exception {
		...
		r = new RestriccioMatiTarda(id,tipus,activat);
	...
	public static void testConstructor2() throws Exception {
		...
		TipusRes tipus = io.readTipusRes();
		io.write("Introdueix Activat (Boolean): \n");
		r = new RestriccioMatiTarda(id,tipus);
		io.write("La Restriccio creada te: \n Id = " + r.getId() + "\n TipusRestriccio = " + (r.getTipus().name()) + "\n");
	}
	...
	public static void testComprovar1() throws Exception {
		if (r.getTipus() == TipusRes.unaria) {
			...
			io.write("Creem un grup 10, de capacitat 30 persones, i l'assignem a FM, com a grup de matí...\n" );
			io.write("Creem una aula A01, de capacitat 30 persones...\n");
			io.write("Creem una sessio de teoria per dilluns de 19h a 20h, pel grup 10 de FM a l'aula A01...\n");			
			...
			Boolean correcte = r.comprovar(s, 0, 11);
			if (correcte) io.write("Concordància entre grup de mati/tarda i hora de la sessio \n");
			else io.write("No concordància entre grup de mati/tarda i hora de la sessio (mati de 8h a 14h, tarda de 14h a 20h) \n");
		}
