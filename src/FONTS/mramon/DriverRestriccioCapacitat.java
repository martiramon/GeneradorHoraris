...
class DriverRestriccioCapacitat {
	private static FONTS.esaus.inout io;
	private static RestriccioCapacitat r;
	...
	public static void testConstructor() throws Exception {
		...
		r = new RestriccioCapacitat(id,tipus,activat);
	...
	public static void testConstructor2() throws Exception {
		...
		TipusRes tipus = io.readTipusRes();
		io.write("Introdueix Activat (Boolean): \n");
		r = new RestriccioCapacitat(id,tipus);
		io.write("La Restriccio creada te: \n Id = " + r.getId() + "\n TipusRestriccio = " + (r.getTipus().name()) + "\n");
	}
	...
	public static void testComprovar1() throws Exception {
		if (r.getTipus() == TipusRes.unaria) {
			...
			io.write("Creem un grup 10, de capacitat 40 persones, i l'assignem a FM...\n" );
			io.write("Creem una aula A01, de capacitat 30 persones...\n");
			io.write("Creem una sessio de teoria per dilluns a les 8h, pel grup 10 de FM a l'aula A01...\n");			
			...
			if (correcte) io.write("L'aula té prou capacitat pel grup 10 de FM");
			else io.write("L'aula no te prou capacitat pel grup 10 de FM");
		}
