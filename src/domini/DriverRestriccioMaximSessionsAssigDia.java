...
class DriverRestriccioMaximSessionsAssigDia {
	private static inout io;
	private static RestriccioMaximSessionsAssigDia r;
	...
	public static void testConstructor() throws Exception {
		...
		r = new RestriccioMaximSessionsAssigDia(id,tipus,activat);
	...
	public static void testConstructor2() throws Exception {
		...
		TipusRes tipus = io.readTipusRes();
		io.write("Introdueix Activat (Boolean): \n");
		r = new RestriccioMaximSessionsAssigDia(id,tipus);
		io.write("La Restriccio creada te: \n Id = " + r.getId() + "\n TipusRestriccio = " + (r.getTipus().name()) + "\n");
	}
	...
	public static void testComprovar1(Sessio s, Sessio[][][] horari) throws Exception {
		if (r.getTipus() == TipusRes.global) {
			...
			io.write("Tenim unes altres sessions de TEO creades, per dilluns de 11h a 12h i de 12h a 13h, pel grup 10 de FM a l'aula A01...\n");
			io.write("Creem sessio pel grup 10 de FM, de 13h a 14h de dilluns a l'aula A01...\n");
		    io.write("Comprovant restricci�...\n");	
			Boolean correcte = r.comprovar(s, horari, 0, 5);
			if (correcte) io.write("Sessions correctes \n");
			else io.write("Ja hi ha sessions 4 sessions per aquest grup-assignatura en aquest dia \n");
		}
	...
	public static void testComprovar2(Sessio s, Sessio[][][] horari) throws Exception {
		if (r.getTipus() == TipusRes.global) {
			...
			io.write("Tenim una aula A01 creada, de capacitat 30 persones, amb tipus aula TEO...\n");
			io.write("Tenim unes sessions de TEO creades, per dilluns de 8h a 9h i de 9h a 10h, pel grup 10 de FM a l'aula A01...\n");
			io.write("Tenim unes altre session de TEO creada, per dilluns de 11h a 12h, pel grup 10 de FM a l'aula A01...\n");
			io.write("Creem sessio pel grup 10 de FM, de 12h a 13h de dilluns a l'aula A01...\n");
		    io.write("Comprovant restricci�...\n");	
			Boolean correcte = r.comprovar(s, horari, 0, 4);
			if (correcte) io.write("Sessions correctes \n");
			else io.write("Ja hi ha sessions 4 sessions per aquest grup-assignatura en aquest dia \n");
		}
		else io.write("La restriccio ha de ser global. Per provar-la canvia el tipus a traves d'un set\n ");
	...
	public static void main(String[] args) throws Exception {
		...
		vSessions.add(s3);
		Sessio s4 = new Sessio("sessio4", idcjAU, idcjGA, idcjTS);
		vSessions.add(s4);
		
		Sessio s5 = new Sessio("sessio5", idcjAU, idcjGA, idcjTS);
		...
		horari[0][2][0] = sessions[2];
		horari[0][3][0] = sessions[3];
		
		Sessio[][][] horari2 = new Sessio[5][12][vSessions.size()];
		horari2[0][0][0] = sessions[0];
		horari2[0][1][0] = sessions[1];
		horari2[0][2][0] = sessions[2];
		...
		while (s != 6) {
			if (s == 1) {
				...
				if (r == null) io.write("S'ha de crear una restriccio abans de comprovar"); 
					...
					s = io.readint();
					if (s == 1) testComprovar1(s5, horari);
					if (s == 2) testComprovar2(s4, horari2);
				}
				io.write("\n");
				io.write("Opcions: \n 1.Constructor \n 2.Getters \n 3.Setters \n 4.Metode \n 5.Exit \n");
			}
