...
public class DriverHorari {
	...
	public static void testHorariCorrecte() throws Exception {
		...
		Integer assig3 = ctr.crearAssignatura("F", "F�sica", 1, tsessions);
		...
		Integer assig7 = ctr.crearAssignatura("M1", "F�sica", 2, tsessions);
		Integer assig8 = ctr.crearAssignatura("M2", "Programaci� 1", 2, tsessions);
