...
class DriverRestriccioHorariLectiu {
	private static inout io;
	private static RestriccioHorariLectiu r;
	...
	public static void testConstructor() throws Exception {
		...
		r = new RestriccioHorariLectiu(id,tipus,activat);
	...
	public static void testConstructor2() throws Exception {
		...
		TipusRes tipus = io.readTipusRes();
		io.write("Introdueix Activat (Boolean): \n");
		r = new RestriccioHorariLectiu(id,tipus);
		io.write("La Restriccio creada te: \n Id = " + r.getId() + "\n TipusRestriccio = " + (r.getTipus().name()) + "\n");
	}
	...
	public static void testComprovar1() throws Exception {
		if (r.getTipus() == TipusRes.unaria) {
			...
			io.write("Creem una sessio de teoria per dilluns de 20h a 21h, pel grup 10 de FM a l'aula A01...\n");			
			...
			if (correcte) io.write("Horari lectiu correcte \n");
			else io.write("Horari lectiu incorrecte (de dilluns a divendres, de 8h a 20h) \n");
		}
