...
class DriverRestriccioMatiTarda {
	...
	public static void testComprovar1() throws Exception {
		if (r.getTipus() == TipusRes.unaria) {
			...
			io.write("Creem un grup 10, de capacitat 30 persones, i l'assignem a FM, com a grup de mat�...\n" );
			...
			if (correcte) io.write("Concord�ncia entre grup de mati/tarda i hora de la sessio \n");
			else io.write("No concord�ncia entre grup de mati/tarda i hora de la sessio (mati de 8h a 14h, tarda de 14h a 20h) \n");
		}
