...
class DriverRestriccioMaximSessionsAssigSeguides {
	private static inout io;
	private static RestriccioMaximSessionsAssigSeguides r;
	...
	public static void testConstructor() throws Exception {
		...
		r = new RestriccioMaximSessionsAssigSeguides(id,tipus,activat);
	...
	public static void testConstructor2() throws Exception {
		...
		TipusRes tipus = io.readTipusRes();
		io.write("Introdueix Activat (Boolean): \n");
		r = new RestriccioMaximSessionsAssigSeguides(id,tipus);
		io.write("La Restriccio creada te: \n Id = " + r.getId() + "\n TipusRestriccio = " + (r.getTipus().name()) + "\n");
	}
	...
	public static void testComprovar1(Sessio s, Sessio[][][] horari) throws Exception {
		if (r.getTipus() == TipusRes.global) {
			...
			io.write("Tenim una sessio de TEO creada, per dilluns de 8h a 9h i de 9h a 10, pel grup 10 de FM a l'aula A01...\n");
			io.write("Creem sessio pel grup 10 de FM, de 10h a 11h de dilluns a l'aula A01...\n");
		    io.write("Comprovant restricci�...\n");	
			Boolean correcte = r.comprovar(s, horari, 0, 2);
			if (correcte) io.write("Sessions correctes \n");
			else io.write("Ja hi ha sessions a les 2 hores anteriors per aquest grup i assignatura \n");
		}
	...
	public static void testComprovar2(Sessio s, Sessio[][][] horari) throws Exception {
		if (r.getTipus() == TipusRes.global) {
			...
			io.write("Tenim una aula A01 creada, de capacitat 30 persones, amb tipus aula TEO...\n");
			io.write("Tenim una sessio de TEO creada, per dilluns de 8h a 9h i de 9h a 10, pel grup 10 de FM a l'aula A01...\n");
			io.write("Creem sessio pel grup 10 de FM, de 11h a 12h de dilluns a l'aula A01...\n");
		    io.write("Comprovant restricci�...\n");
	...
	public static void main(String[] args) throws Exception {
		...
		au.setTipus(idcjTA); 
		TipusSessio ts = new TipusSessio("TEO", idcjTA, 3); 
		...
		while (s != 6) {
			if (s == 1) {
				...
				if (r == null) io.write("S'ha de crear una restriccio abans de comprovar"); 
					...
					if (s == 2) testComprovar2(s3, horari);
				}
				io.write("\n");
				io.write("Opcions: \n 1.Constructor \n 2.Getters \n 3.Setters \n 4.Metode \n 5.Exit \n");
			}
